...
# -*- coding: utf-8 -*-
"""
msgpackio documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "msgpackio"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)

import msgpackio  # noqa
...
project = u"msgpackio"
_full_version = msgpackio.__version__
author = msgpackio.__author__
copyright = msgpackio.__copyright__
...
htmlhelp_basename = "msgpackio-doc"
...
latex_documents = [
    (master_doc, "msgpackio.tex", u"msgpackio Documentation", u"authors", "manual"),
]
...
man_pages = [(master_doc, "msgpackio", "msgpackio Documentation", [author], 1)]
